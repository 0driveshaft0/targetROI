...
adduct_names <- c(
  "M+Cl", "M-H", "M+Hac-H", "M+Br", "M-Cl", "M-HCl", "M-Br",
  "M-HBr"
)
...
get_ions <- function(forms, adduct) {
  default_df <- data.frame(matrix(, nrow = 0, ncol = 4, dimnames = list(
    c(),
...
ion_forms <- ion_forms[, c(
  "ion_formula", "adduct", "charge", "chemical",
  "chemical_type"
)]
