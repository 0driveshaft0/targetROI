shinydashboard::tabItem(
  ...
  shiny::column(
    width = 3,
    shinydashboard::box(
      width = 12, id = "regression_params",
      shinyWidgets::radioGroupButtons("regression_files_params", "",
        justified = TRUE,
      ...
      shiny::tags$div(
        id = "regression_observed",
        shiny::selectInput("regression_observed_file", "Sample",
          choices = c(),
          multiple = FALSE
        ),
      ...
      shinyjs::hidden(
        shiny::tags$div(
          id = "regression_theoretic",
          shiny::selectInput("regression_theoretic_files", "Samples",
            choices = c(),
            multiple = TRUE
          ),
    ...
    shinydashboard::box(
      width = 12, id = "regression_table_results",
      DT::dataTableOutput("regression_table")
    )
  ),
  shinydashboard::box(
    width = 9, id = "regression_results",
    shiny::downloadButton("regression_export", "Export regression matrix"),
    shinyWidgets::radioGroupButtons("regression_matrix_choice", "",
      justified = TRUE,
