shinydashboard::tabItem(
  ...
  shinydashboard::box(
    ...
    shiny::tags$div(
      ...
      shiny::selectInput("process_results_study",
        "Type",
        choices = c(), width = "30vw"
      ),
      shinyjs::hidden(
        # To show when standard choose
        shiny::tags$div(
          id = "process_results_standard",
  ...
  shinydashboard::box(
    ...
    shiny::column(
      width = 1, style = "margin-top: 20px; margin-bottom: 20px;",
      shiny::actionButton("process_results_apply", "Apply")
    ),
    shinyWidgets::radioGroupButtons("process_results_selected_matrix", "",
      justified = TRUE,
    ...
    shiny::column(
      ...
      shinyjs::hidden(
        shiny::tags$div(
          id = "process_results_profile_div",
