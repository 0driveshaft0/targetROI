shinydashboard::tabItem(
  ...
  shinydashboard::box(
    ...
    shinyWidgets::radioGroupButtons("process_chemical_standard", "",
      justified = TRUE,
    ...
    shiny::tags$div(
      ...
      shiny::selectInput("process_instrument", "Instrument",
        choices = c(
          "Orbitrap", "QTOF_XevoG2-S", "Sciex_TripleTOF5600",
      ...
      shiny::tags$div(
        ...
        shiny::tags$table(
          style = "text-align: center; white-space: nowrap; margi-top: -20px;",
          shiny::tags$tr(
            shiny::tags$td(
