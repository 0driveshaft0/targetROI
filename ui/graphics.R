shinydashboard::tabItem(
  tabName = "graphics",
  shinydashboard::box(
    width = 3, id = "graphics_params",
    shiny::radioButtons("graphics_data", "",
      choices = c("Intensities", "Scores", "Deviations"),
      inline = TRUE
    ),
    shiny::selectInput("graphics_file", "Sample",
      choices = c(),
      multiple = FALSE
    ),
    ...
    shinyjs::hidden(
      shiny::tags$div(
        id = "graphics_bubble_params", style = "margin-left: 20px",
    ...
    shinyjs::hidden(
      shiny::tags$div(
        id = "graphics_contours_params", style = "margin-left: 20px",
        bsplus::shinyInput_label_embed(
  ...
  shinydashboard::box(
    width = 9,
    shiny::column(
      width = 6, style = "border-right : 1px solid #ddd",
