shinydashboard::tabItem(
  tabName = "project_files",
  shiny::column(id = "user_box", width = 2, shinydashboard::box(
    width = 12, title = "New user",
    shiny::textInput("login", "Name or intials",
      placeholder = "Enter a name"
    ),
    shiny::column(
      width = 12, style = "text-align:center",
      shinyWidgets::actionBttn("user_create", "Create",
        style = "minimal",
        color = "primary"
      )
    )
  )),
  shiny::column(id = "project_box", width = 4, shinydashboard::box(
    width = 12, title = "New sequence",
    shiny::fluidRow(
      shiny::column(
        width = 6,
  ...
  shiny::column(id = "file_box", width = 6, shinydashboard::box(
    width = 12, title = "Add file(s)",
    shiny::column(
      width = 6,
      ...
      shiny::fluidRow(
        shiny::column(
          width = 12,
          shiny::selectizeInput("files_from_db",
            label = NULL,
      ...
      tags$div(
        ...
        tags$div(
          ...
          tags$label(
            ...
            shiny::tags$a(
              class = "bttn bttn-no-fill bttn-primary bttn-no-outline",
              shiny::icon("upload"),
